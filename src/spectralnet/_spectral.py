...
class SpectralNet:
    def __init__(
        ...
        """SpectralNet A class for implementing SpectralNet, a machine learning model for clustering,
        which optionally utilizes Autoencoders (AE) and Siamese networks for training.
